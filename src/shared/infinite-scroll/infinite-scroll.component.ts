...
import { Component, OnInit, ChangeDetectionStrategy, ViewChild, AfterViewInit, NgZone, ChangeDetectorRef, Input, inject, Output, EventEmitter } from '@angular/core';
...
export class InfiniteScrollComponent implements OnInit, AfterViewInit {
  @ViewChild('scroller', { static: true }) scroller: CdkVirtualScrollViewport = {} as CdkVirtualScrollViewport;
  @Input() listItems: any[] = [];
  @Input() loading = false;
